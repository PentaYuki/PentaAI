"""PentaSchool backend — LMS K12 than thien (lop 1-12)."""
...
app = FastAPI(title="PentaSchool LMS K12", version="0.2.0")
...
@app.get("/api/health")
def health():
    return {"ok": True, "app": "pentaschool", "lop": "1-12", "style": "de-thuong-nghiem-tuc", "db": DB_INFO}
